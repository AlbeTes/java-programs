...
public class MilitaryAdministrationBody extends MilitaryPersonnel{
    ...
    public MilitaryAdministrationBody(String surname, String company, String title, String dateOfBirth, String dateIntoService, String militaryUnit, String districtName, String position, String yearsOfService, String bonusAmount, int salaryAmount) {
        super(surname, company, title, dateOfBirth, dateIntoService, militaryUnit, salaryAmount);
